...
public class StopsFragment extends Fragment {
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            @Override public void onItemClick(View view, int position) {
                                ...
                                if (item.getTitle().equalsIgnoreCase("no favourites") == false) {
                                    ...
                                    intent.putExtra("stop_name", item.getRouteName());
    ...
    private List<RouteInfo> createList() {
        ...
        pref = getActivity().getSharedPreferences("stops", Context.MODE_PRIVATE);
        editor = pref.edit();
        ...
        for (String route : routeID){
            ...
            Set<String> S;
            S = pref.getStringSet(route, null);

            if (S != null) {
                Iterator<String> test = S.iterator();

                while (test.hasNext()) {
                    String routeName = test.next();
                    Log.d("StopsFragment", "String is: " + routeName);

                    RouteInfo routeData = new RouteInfo();
                    routeData.setTitle("Route " + route);
